...
//     final Map<String, dynamic> personalDetails = signupData['personaldetails'] ?? {};
...
//             Text("A. Personal Details", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
...
//             buildRow("Farm Address", signupData['farmaddress'] ?? 'Not provided'),

//             Divider(),

//             buildRow("Land Details", signupData['landDetails'] ?? 'Not provided'),

//             Divider(),

//             buildRow("Crop Details", signupData['cropDetails'] ?? 'Not provided'),

//             Divider(),

//             buildRow("Account Holder Name", signupData['accountholdername'] ?? 'Not provided'),
//             buildRow("Account Number", signupData['accountnumber'] ?? 'Not provided'),
//             buildRow("IFSC Code", signupData['ifsccode'] ?? 'Not provided'),
...
//             buildImageBox("Field", signupData['fieldUrl'] ?? ''),
...
//                   onPressed: () async {
//                     try {
//                       CollectionReference farmers = FirebaseFirestore.instance
//                           .collection('farmers');
