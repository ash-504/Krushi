...
import 'package:krushi/partner_document.dart';

class PartnerBankDetails extends StatefulWidget {
  final Map<String, dynamic> signupData;

  const PartnerBankDetails({Key? key, required this.signupData}) : super(key: key);
  @override
  State<PartnerBankDetails> createState() => _PartnerBankDetails();
}

class _PartnerBankDetails extends State<PartnerBankDetails> {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) =>
                                PartnerDocumentDetails(signupData: signupData),
                      ),
                    );
                  } else {
