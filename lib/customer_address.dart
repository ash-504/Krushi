...
class CustomerAddressDetails extends StatefulWidget {
  ...
  const CustomerAddressDetails({Key? key, required this.signupData})
    : super(key: key);

  @override
  State<CustomerAddressDetails> createState() => _CustomerAddressDetails();
}

class _CustomerAddressDetails extends State<CustomerAddressDetails> {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) =>
                                CustomerReviewDetails(signupData: signupData),
                      ),
                    );
                  } else {
